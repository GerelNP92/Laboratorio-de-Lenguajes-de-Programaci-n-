...
-- Nombre del estudiante: Gerel Enrique, Negreira Peruzzi
-- Carnet: 09-11163
-------------------------------------------------------------------------------
...
parsearCondicional = map parsearUno
  where
    parsearUno :: String -> Either String Int
    parsearUno s = case readMaybe s of
        Just n  -> Right n
